...
<body>
	...
	<div class="box-form">
		...
		<div class="right">
			<h5>SignUp</h5>
			<p style="font-weight:bold;">Already have an account?<a href="/E-commerces/E-Commerce/User/index.php" style="text-decoration:none; font-weight:bold; font-size:large; cursor:pointer;">Login Now</a></p>
